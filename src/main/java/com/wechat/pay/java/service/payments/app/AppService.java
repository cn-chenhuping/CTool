...
public class AppService {
   ...
   */
  public void closeOrder(com.wechat.pay.java.service.payments.app.model.CloseOrderRequest request) {
    String requestPath =
   ...
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public com.wechat.pay.java.service.payments.app.model.PrepayResponse prepay(com.wechat.pay.java.service.payments.app.model.PrepayRequest request) {
    String requestPath = "https://api.mch.weixin.qq.com/v3/pay/transactions/app";
    com.wechat.pay.java.service.payments.app.model.PrepayRequest realRequest = request;
    if (this.hostName != null) {
      requestPath = requestPath.replaceFirst(HostName.API.getValue(), hostName.getValue());
    }
    HttpHeaders headers = new HttpHeaders();
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<com.wechat.pay.java.service.payments.app.model.PrepayResponse> httpResponse =
        httpClient.execute(httpRequest, com.wechat.pay.java.service.payments.app.model.PrepayResponse.class);
  ...
  public Transaction queryOrderById(com.wechat.pay.java.service.payments.app.model.QueryOrderByIdRequest request) {
    ...
    com.wechat.pay.java.service.payments.app.model.QueryOrderByIdRequest realRequest = request;
    // 添加 path param
    requestPath =
        requestPath.replace(
  ...
  public Transaction queryOrderByOutTradeNo(com.wechat.pay.java.service.payments.app.model.QueryOrderByOutTradeNoRequest request) {
    ...
    com.wechat.pay.java.service.payments.app.model.QueryOrderByOutTradeNoRequest realRequest = request;
    // 添加 path param
    requestPath =
        requestPath.replace("{" + "out_trade_no" + "}", urlEncode(realRequest.getOutTradeNo()));
