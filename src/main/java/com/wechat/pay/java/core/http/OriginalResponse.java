...
public class OriginalResponse {
  ...
  public static class Builder {
     ...
     */
    public com.wechat.pay.java.core.http.OriginalResponse build() {
      Objects.requireNonNull(request);
      return new com.wechat.pay.java.core.http.OriginalResponse(request, statusCode, headers, contentType, jsonBody);
    }
  }
}
