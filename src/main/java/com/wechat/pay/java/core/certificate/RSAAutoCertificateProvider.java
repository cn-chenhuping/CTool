...
public class RSAAutoCertificateProvider extends AbstractAutoCertificateProvider {
  ...
  public static class Builder {
    ...
    public com.wechat.pay.java.core.certificate.RSAAutoCertificateProvider build() {
      if (httpClient == null) {
      ...
      return new com.wechat.pay.java.core.certificate.RSAAutoCertificateProvider(
