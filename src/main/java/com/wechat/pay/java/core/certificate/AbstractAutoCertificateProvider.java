...
public abstract class AbstractAutoCertificateProvider implements CertificateProvider {
  private static final Logger log = LoggerFactory.getLogger(com.wechat.pay.java.core.certificate.AbstractAutoCertificateProvider.class);
  ...
  protected AbstractAutoCertificateProvider(
    ...
    synchronized (com.wechat.pay.java.core.certificate.AbstractAutoCertificateProvider.class) {
