...
public final class OkHttpClientAdapter extends AbstractHttpClient {
  ...
  private static final Logger logger = LoggerFactory.getLogger(com.wechat.pay.java.core.http.okhttp.OkHttpClientAdapter.class);
  ...
  private RequestBody createRequestBody(String content, okhttp3.MediaType mediaType) {
  ...
  @SuppressWarnings("deprecation")
  private RequestBody createRequestBody(byte[] content, okhttp3.MediaType mediaType) {
    return RequestBody.create(mediaType, content);
  }
